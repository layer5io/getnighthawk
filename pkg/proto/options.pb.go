...
func (H1ConnectionReuseStrategy_H1ConnectionReuseStrategyOptions) EnumDescriptor() ([]byte, []int) {
	return file_options_proto_rawDescGZIP(), []int{8, 0}
}
...
type RequestOptions struct {
	...
	RequestBodySize *wrappers.UInt32Value `protobuf:"bytes,3,opt,name=request_body_size,json=requestBodySize,proto3" json:"request_body_size,omitempty"`
}
...
func (x *RequestOptions) GetRequestBodySize() *wrappers.UInt32Value {
	if x != nil {
...
type MultiTarget struct {
	...
	UseHttps *wrappers.BoolValue `protobuf:"bytes,1,opt,name=use_https,json=useHttps,proto3" json:"use_https,omitempty"`
...
func (x *MultiTarget) GetUseHttps() *wrappers.BoolValue {
	if x != nil {
		return x.UseHttps
	}
	return nil
...
func (x *MultiTarget) GetPath() *wrappers.StringValue {
	if x != nil {
		return x.Path
	}
	return nil
...
type CommandLineOptions struct {
	...
	RequestsPerSecond *wrappers.UInt32Value `protobuf:"bytes,1,opt,name=requests_per_second,json=requestsPerSecond,proto3" json:"requests_per_second,omitempty"`
	// The maximum allowed number of concurrent connections per event loop. HTTP/1 only. Default: 100.
	Connections *wrappers.UInt32Value `protobuf:"bytes,2,opt,name=connections,proto3" json:"connections,omitempty"`
	...
	// Use HTTP/2
	H2 *wrappers.BoolValue `protobuf:"bytes,5,opt,name=h2,proto3" json:"h2,omitempty"`
	...
	Concurrency *wrappers.StringValue `protobuf:"bytes,6,opt,name=concurrency,proto3" json:"concurrency,omitempty"` // [(validate.rules).string = {pattern: "^([0-9]*|auto)$"}];
	...
	PrefetchConnections *wrappers.BoolValue `protobuf:"bytes,9,opt,name=prefetch_connections,json=prefetchConnections,proto3" json:"prefetch_connections,omitempty"`
	// Release requests in bursts of the specified size (default: 0).
	BurstSize *wrappers.UInt32Value `protobuf:"bytes,10,opt,name=burst_size,json=burstSize,proto3" json:"burst_size,omitempty"`
	...
	MaxPendingRequests *wrappers.UInt32Value `protobuf:"bytes,14,opt,name=max_pending_requests,json=maxPendingRequests,proto3" json:"max_pending_requests,omitempty"`
	// The maximum allowed number of concurrently active requests. HTTP/2 only. (default: 100).
	MaxActiveRequests *wrappers.UInt32Value `protobuf:"bytes,15,opt,name=max_active_requests,json=maxActiveRequests,proto3" json:"max_active_requests,omitempty"`
	// Max requests per connection (default: 4294937295).
	MaxRequestsPerConnection *wrappers.UInt32Value `protobuf:"bytes,16,opt,name=max_requests_per_connection,json=maxRequestsPerConnection,proto3" json:"max_requests_per_connection,omitempty"`
	...
	Trace *wrappers.StringValue `protobuf:"bytes,19,opt,name=trace,proto3" json:"trace,omitempty"` // [(validate.rules).string.uri = true];
	...
	OpenLoop *wrappers.BoolValue `protobuf:"bytes,21,opt,name=open_loop,json=openLoop,proto3" json:"open_loop,omitempty"`
	...
	JitterUniform *duration.Duration `protobuf:"bytes,25,opt,name=jitter_uniform,json=jitterUniform,proto3" json:"jitter_uniform,omitempty"`
	// Nighthawk service uri for running CLI in remote host mode. Example: grpc://localhost:8843/.
	// Default is empty.
	// NOTE: not relevant to gRPC service
	NighthawkService *wrappers.StringValue `protobuf:"bytes,31,opt,name=nighthawk_service,json=nighthawkService,proto3" json:"nighthawk_service,omitempty"` // [(validate.rules).string.uri = true];
	// Use experimental HTTP/2 pool which will use multiple connections.
	// WARNING: feature may be removed or changed in the future!
	ExperimentalH2UseMultipleConnections *wrappers.BoolValue `protobuf:"bytes,30,opt,name=experimental_h2_use_multiple_connections,json=experimentalH2UseMultipleConnections,proto3" json:"experimental_h2_use_multiple_connections,omitempty"`
	...
	SimpleWarmup *wrappers.BoolValue `protobuf:"bytes,32,opt,name=simple_warmup,json=simpleWarmup,proto3" json:"simple_warmup,omitempty"`
	...
	StatsFlushInterval *wrappers.UInt32Value `protobuf:"bytes,35,opt,name=stats_flush_interval,json=statsFlushInterval,proto3" json:"stats_flush_interval,omitempty"`
	...
	// arrivals.
	LatencyResponseHeaderName *wrappers.StringValue `protobuf:"bytes,36,opt,name=latency_response_header_name,json=latencyResponseHeaderName,proto3" json:"latency_response_header_name,omitempty"`
	// Provide an execution starting date and time. Optional, any value specified must be in the
	// future.
	ScheduledStart *timestamp.Timestamp `protobuf:"bytes,105,opt,name=scheduled_start,json=scheduledStart,proto3" json:"scheduled_start,omitempty"`
	...
	ExecutionId *wrappers.StringValue `protobuf:"bytes,106,opt,name=execution_id,json=executionId,proto3" json:"execution_id,omitempty"`
}
...
func (x *CommandLineOptions) GetRequestsPerSecond() *wrappers.UInt32Value {
	if x != nil {
...
func (x *CommandLineOptions) GetConnections() *wrappers.UInt32Value {
	if x != nil {
...
func (x *CommandLineOptions) GetDuration() *duration.Duration {
...
func (x *CommandLineOptions) GetNoDuration() *wrappers.BoolValue {
...
func (x *CommandLineOptions) GetTimeout() *duration.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *CommandLineOptions) GetH2() *wrappers.BoolValue {
	if x != nil {
		return x.H2
	}
	return nil
...
func (x *CommandLineOptions) GetConcurrency() *wrappers.StringValue {
	if x != nil {
...
func (x *CommandLineOptions) GetPrefetchConnections() *wrappers.BoolValue {
	if x != nil {
...
func (x *CommandLineOptions) GetBurstSize() *wrappers.UInt32Value {
	if x != nil {
		return x.BurstSize
	}
	return nil
...
func (x *CommandLineOptions) GetMaxPendingRequests() *wrappers.UInt32Value {
	if x != nil {
...
func (x *CommandLineOptions) GetMaxActiveRequests() *wrappers.UInt32Value {
	if x != nil {
...
func (x *CommandLineOptions) GetMaxRequestsPerConnection() *wrappers.UInt32Value {
	if x != nil {
...
func (x *CommandLineOptions) GetUri() *wrappers.StringValue {
...
func (x *CommandLineOptions) GetTrace() *wrappers.StringValue {
	if x != nil {
		return x.Trace
	}
	return nil
...
func (x *CommandLineOptions) GetOpenLoop() *wrappers.BoolValue {
	if x != nil {
		return x.OpenLoop
	}
	return nil
...
func (x *CommandLineOptions) GetJitterUniform() *duration.Duration {
	if x != nil {
...
func (x *CommandLineOptions) GetNighthawkService() *wrappers.StringValue {
	if x != nil {
...
func (x *CommandLineOptions) GetExperimentalH2UseMultipleConnections() *wrappers.BoolValue {
	if x != nil {
...
func (x *CommandLineOptions) GetSimpleWarmup() *wrappers.BoolValue {
	if x != nil {
...
func (x *CommandLineOptions) GetStatsFlushInterval() *wrappers.UInt32Value {
	if x != nil {
...
func (x *CommandLineOptions) GetLatencyResponseHeaderName() *wrappers.StringValue {
	if x != nil {
...
func (x *CommandLineOptions) GetScheduledStart() *timestamp.Timestamp {
	if x != nil {
...
func (x *CommandLineOptions) GetExecutionId() *wrappers.StringValue {
	if x != nil {
...
type CommandLineOptions_NoDuration struct {
	...
	NoDuration *wrappers.BoolValue `protobuf:"bytes,33,opt,name=no_duration,json=noDuration,proto3,oneof"`
}
...
type CommandLineOptions_Uri struct {
	...
	Uri *wrappers.StringValue `protobuf:"bytes,18,opt,name=uri,proto3,oneof"` // [(validate.rules).string.uri = true];
}
...
func (*MultiTarget_Endpoint) Descriptor() ([]byte, []int) {
	return file_options_proto_rawDescGZIP(), []int{7, 0}
}

func (x *MultiTarget_Endpoint) GetAddress() *wrappers.StringValue {
	if x != nil {
		return x.Address
	}
	return nil
...
func (x *MultiTarget_Endpoint) GetPort() *wrappers.UInt32Value {
	if x != nil {
		return x.Port
	}
	return nil
...
var file_options_proto_rawDesc = []byte{
	...
	0x10, 0x6e, 0x69, 0x67, 0x68, 0x74, 0x68, 0x61, 0x77, 0x6b, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e,
	...
	0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x34, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2f,
	...
	0x2f, 0x76, 0x33, 0x2f, 0x63, 0x65, 0x72, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x24,
	...
	0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x84, 0x02,
	0x0a, 0x0e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	0x12, 0x4a, 0x0a, 0x0e, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x6d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79,
	0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x33, 0x2e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x52, 0x0d, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x12, 0x50, 0x0a, 0x0f,
	...
	,
	...
	,
	...
	,
	...
	0x00, 0x12, 0x07, 0x0a, 0x03, 0x4d, 0x52, 0x55, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x4c, 0x52,
	0x55, 0x10, 0x02, 0x22, 0x87, 0x19, 0x0a, 0x12, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x4c,
	0x69, 0x6e, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x59, 0x0a, 0x13, 0x72, 0x65,
	...
	,
	...
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x01, 0x52, 0x19, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x6c, 0x75, 0x67,
	0x69, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x62, 0x0a, 0x0b, 0x74, 0x6c, 0x73, 0x5f,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3d, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x3f, 0x0a, 0x0d, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x5f, 0x77, 0x61, 0x72, 0x6d, 0x75,
	0x70, 0x18, 0x20, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x42, 0x6f, 0x6f, 0x6c, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x52, 0x0c, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x57, 0x61, 0x72, 0x6d, 0x75,
	0x70, 0x12, 0x43, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x73, 0x5f, 0x73, 0x69, 0x6e, 0x6b, 0x73,
	0x18, 0x22, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x2e, 0x63,
	...
	,
	...
	,
}
...
var file_options_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_options_proto_goTypes = []interface{}{
	...
	(*RequestOptions)(nil),                                          // 5: nighthawk.client.RequestOptions
	(*RequestOptionsList)(nil),                                      // 6: nighthawk.client.RequestOptionsList
	(*RequestSource)(nil),                                           // 7: nighthawk.client.RequestSource
	(*AddressFamily)(nil),                                           // 8: nighthawk.client.AddressFamily
	(*Verbosity)(nil),                                               // 9: nighthawk.client.Verbosity
	(*OutputFormat)(nil),                                            // 10: nighthawk.client.OutputFormat
	(*SequencerIdleStrategy)(nil),                                   // 11: nighthawk.client.SequencerIdleStrategy
	(*MultiTarget)(nil),                                             // 12: nighthawk.client.MultiTarget
	(*H1ConnectionReuseStrategy)(nil),                               // 13: nighthawk.client.H1ConnectionReuseStrategy
	(*CommandLineOptions)(nil),                                      // 14: nighthawk.client.CommandLineOptions
	(*MultiTarget_Endpoint)(nil),                                    // 15: nighthawk.client.MultiTarget.Endpoint
	nil,                                                             // 16: nighthawk.client.CommandLineOptions.TerminationPredicatesEntry
	nil,                                                             // 17: nighthawk.client.CommandLineOptions.FailurePredicatesEntry
	(v3.RequestMethod)(0),                                           // 18: envoy.config.core.v3.RequestMethod
	...
	(*v31.UpstreamTlsContext)(nil),                                  // 25: envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext
	(*v3.TransportSocket)(nil),                                      // 26: envoy.config.core.v3.TransportSocket
	(*v32.StatsSink)(nil),                                           // 27: envoy.config.metrics.v3.StatsSink
	(*timestamp.Timestamp)(nil),                                     // 28: google.protobuf.Timestamp
}
var file_options_proto_depIdxs = []int32{
	18, // 0: nighthawk.client.RequestOptions.request_method:type_name -> envoy.config.core.v3.RequestMethod
	19, // 1: nighthawk.client.RequestOptions.request_headers:type_name -> envoy.config.core.v3.HeaderValueOption
	20, // 2: nighthawk.client.RequestOptions.request_body_size:type_name -> google.protobuf.UInt32Value
	5,  // 3: nighthawk.client.RequestOptionsList.options:type_name -> nighthawk.client.RequestOptions
	...
	21, // 8: nighthawk.client.MultiTarget.use_https:type_name -> google.protobuf.BoolValue
	15, // 9: nighthawk.client.MultiTarget.endpoints:type_name -> nighthawk.client.MultiTarget.Endpoint
	22, // 10: nighthawk.client.MultiTarget.path:type_name -> google.protobuf.StringValue
	...
	20, // 12: nighthawk.client.CommandLineOptions.requests_per_second:type_name -> google.protobuf.UInt32Value
	20, // 13: nighthawk.client.CommandLineOptions.connections:type_name -> google.protobuf.UInt32Value
	23, // 14: nighthawk.client.CommandLineOptions.duration:type_name -> google.protobuf.Duration
	21, // 15: nighthawk.client.CommandLineOptions.no_duration:type_name -> google.protobuf.BoolValue
	23, // 16: nighthawk.client.CommandLineOptions.timeout:type_name -> google.protobuf.Duration
	21, // 17: nighthawk.client.CommandLineOptions.h2:type_name -> google.protobuf.BoolValue
	22, // 18: nighthawk.client.CommandLineOptions.concurrency:type_name -> google.protobuf.StringValue
	9,  // 19: nighthawk.client.CommandLineOptions.verbosity:type_name -> nighthawk.client.Verbosity
	10, // 20: nighthawk.client.CommandLineOptions.output_format:type_name -> nighthawk.client.OutputFormat
	21, // 21: nighthawk.client.CommandLineOptions.prefetch_connections:type_name -> google.protobuf.BoolValue
	20, // 22: nighthawk.client.CommandLineOptions.burst_size:type_name -> google.protobuf.UInt32Value
	8,  // 23: nighthawk.client.CommandLineOptions.address_family:type_name -> nighthawk.client.AddressFamily
	5,  // 24: nighthawk.client.CommandLineOptions.request_options:type_name -> nighthawk.client.RequestOptions
	7,  // 25: nighthawk.client.CommandLineOptions.request_source:type_name -> nighthawk.client.RequestSource
	24, // 26: nighthawk.client.CommandLineOptions.request_source_plugin_config:type_name -> envoy.config.core.v3.TypedExtensionConfig
	25, // 27: nighthawk.client.CommandLineOptions.tls_context:type_name -> envoy.extensions.transport_sockets.tls.v3.UpstreamTlsContext
	20, // 28: nighthawk.client.CommandLineOptions.max_pending_requests:type_name -> google.protobuf.UInt32Value
	20, // 29: nighthawk.client.CommandLineOptions.max_active_requests:type_name -> google.protobuf.UInt32Value
	20, // 30: nighthawk.client.CommandLineOptions.max_requests_per_connection:type_name -> google.protobuf.UInt32Value
	11, // 31: nighthawk.client.CommandLineOptions.sequencer_idle_strategy:type_name -> nighthawk.client.SequencerIdleStrategy
	22, // 32: nighthawk.client.CommandLineOptions.uri:type_name -> google.protobuf.StringValue
	12, // 33: nighthawk.client.CommandLineOptions.multi_target:type_name -> nighthawk.client.MultiTarget
	22, // 34: nighthawk.client.CommandLineOptions.trace:type_name -> google.protobuf.StringValue
	13, // 35: nighthawk.client.CommandLineOptions.experimental_h1_connection_reuse_strategy:type_name -> nighthawk.client.H1ConnectionReuseStrategy
	16, // 36: nighthawk.client.CommandLineOptions.termination_predicates:type_name -> nighthawk.client.CommandLineOptions.TerminationPredicatesEntry
	17, // 37: nighthawk.client.CommandLineOptions.failure_predicates:type_name -> nighthawk.client.CommandLineOptions.FailurePredicatesEntry
	21, // 38: nighthawk.client.CommandLineOptions.open_loop:type_name -> google.protobuf.BoolValue
	23, // 39: nighthawk.client.CommandLineOptions.jitter_uniform:type_name -> google.protobuf.Duration
	22, // 40: nighthawk.client.CommandLineOptions.nighthawk_service:type_name -> google.protobuf.StringValue
	21, // 41: nighthawk.client.CommandLineOptions.experimental_h2_use_multiple_connections:type_name -> google.protobuf.BoolValue
	26, // 42: nighthawk.client.CommandLineOptions.transport_socket:type_name -> envoy.config.core.v3.TransportSocket
	21, // 43: nighthawk.client.CommandLineOptions.simple_warmup:type_name -> google.protobuf.BoolValue
	27, // 44: nighthawk.client.CommandLineOptions.stats_sinks:type_name -> envoy.config.metrics.v3.StatsSink
	20, // 45: nighthawk.client.CommandLineOptions.stats_flush_interval:type_name -> google.protobuf.UInt32Value
	22, // 46: nighthawk.client.CommandLineOptions.latency_response_header_name:type_name -> google.protobuf.StringValue
	28, // 47: nighthawk.client.CommandLineOptions.scheduled_start:type_name -> google.protobuf.Timestamp
	22, // 48: nighthawk.client.CommandLineOptions.execution_id:type_name -> google.protobuf.StringValue
	22, // 49: nighthawk.client.MultiTarget.Endpoint.address:type_name -> google.protobuf.StringValue
	20, // 50: nighthawk.client.MultiTarget.Endpoint.port:type_name -> google.protobuf.UInt32Value
